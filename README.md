...
# Download Now
Head on over to [Nightly Builds page](https://github.com/deckarep/larry-pops-up/releases/tag/nightly) and just select your operating system for install.
Currently, these executables have no code-signing or notarization so your operating system's security will likely prevent it from opening.

## Opening on MacOS
Just right-click and open - when prompted asking if it's okay give it approval, going forward you can just double-click the app.
